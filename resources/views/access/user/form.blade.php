...
<div class="form-group {{ $errors->has('active') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {{ Form::radio('active', '0', true) }} Deactive
...
{{-- <div class="form-group {{ $errors->has('active') ? 'has-error' : ''}}">
    <div class="col-md-6">
        {!! Form::radio('active', 1, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!} 
        {!! Form::label('active', 'Active', ['class' => 'col-md-4 control-label']) !!}
        <br>
        {!! Form::radio('active', 0, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! Form::label('active', 'Deactive', ['class' => 'col-md-4 control-label']) !!}
        {!! $errors->first('active', '<p class="help-block">:message</p>') !!}
    </div>
</div> --}}

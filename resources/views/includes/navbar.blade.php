<header class="app-header navbar">
  ...
  <ul class="nav navbar-nav ml-auto mr-3">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <a class="dropdown-item" href="{{ route('profile.index') }}"><i class="fa fa-user"></i> Profile<span class="badge badge-info">42</span></a>
  ...
  {{-- <button style="display: none;" class="navbar-toggler aside-menu-toggler" type="button">
    <span class="navbar-toggler-icon"></span>
  </button> --}}
